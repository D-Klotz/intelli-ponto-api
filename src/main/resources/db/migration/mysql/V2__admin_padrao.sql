...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Intelli-Ponto IT');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@intelliPonto.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
